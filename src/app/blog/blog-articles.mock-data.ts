      ...
      sections: [
        {
          ...
          content: "Artificial intelligence is revolutionizing web design by automating tasks like image optimization, A/B testing, and user experience enhancements.",
          illustration: {
